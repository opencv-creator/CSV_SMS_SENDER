...
public class SmsService extends Service {
    public static final String ACTION_UPDATE = "in.co.jobguidance.UPDATE";
    public static final String ACTION_STOP = "in.co.jobguidance.STOP";
